    ...
    Partial Public Class ProjectsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Projects] ([project_name], [date_started], [date_ended], [design_wid"& _ 
                ...
                "olour], [grid5_colour], [grid10_colour], [design_file]) VALUES (@project_name, @"& _ 
                "date_started, @date_ended, @design_width, @design_height, @fabric_width, @fabric"& _ 
                "_height, @fabric_colour, @grid1_colour, @grid5_colour, @grid10_colour, @design_f"& _ 
                "ile);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT project_id, project_name, date_started, date_ended, design_width, "& _ 
                "design_height, fabric_width, fabric_height, fabric_colour, grid1_colour, grid5_c"& _ 
                "olour, grid10_colour, design_file FROM Projects WHERE (project_id = SCOPE_IDENTI"& _ 
                "TY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Projects] SET [project_name] = @project_name, [date_started] = @date_star"& _ 
                ...
                "_file WHERE (([project_id] = @Original_project_id) AND ([project_name] = @Origin"& _ 
                "al_project_name) AND ((@IsNull_date_started = 1 AND [date_started] IS NULL) OR ("& _ 
                "[date_started] = @Original_date_started)) AND ((@IsNull_date_ended = 1 AND [date"& _ 
                "_ended] IS NULL) OR ([date_ended] = @Original_date_ended)) AND ([design_width] ="& _ 
                " @Original_design_width) AND ([design_height] = @Original_design_height) AND ([f"& _ 
                "abric_width] = @Original_fabric_width) AND ([fabric_height] = @Original_fabric_h"& _ 
                "eight) AND ([fabric_colour] = @Original_fabric_colour) AND ([grid1_colour] = @Or"& _ 
                "iginal_grid1_colour) AND ([grid5_colour] = @Original_grid5_colour) AND ([grid10_"& _ 
                "colour] = @Original_grid10_colour) AND ([design_file] = @Original_design_file));"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT project_id, project_name, date_started, date_ended, design_width, desig"& _ 
                "n_height, fabric_width, fabric_height, fabric_colour, grid1_colour, grid5_colour"& _ 
                ", grid10_colour, design_file FROM Projects WHERE (project_id = @project_id)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT project_id, project_name, date_started, date_ended, design_width, design_h"& _ 
                ...
                "rid10_colour, design_file FROM Projects"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            ...
            Me._commandCollection(2).CommandText = "SELECT project_id, project_name, date_ended, date_started, design_height, design_"& _ 
                ...
                "grid5_colour, design_file FROM Projects WHERE (project_id = @id)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(3).CommandText = "INSERT INTO Projects"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         (project_name, date_started, date_"& _ 
                ...
                "grid1_colour, grid5_colour, grid10_colour, design_file)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES        (@project"& _ 
                "_name,@date_started,@date_ended,@design_width,@design_height,@fabric_width,@fabr"& _ 
                "ic_height,@fabric_colour,@grid1_colour,@grid5_colour,@grid10_colour,@designfile)"& _ 
            ...
            Me._commandCollection(4).CommandText = "SET IDENTITY_INSERT projects ON;"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"INSERT INTO Projects"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         "& _ 
                ...
                "_colour, design_file)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"VALUES        (@Id,@project_name,@date_started,@date_ende"& _ 
                "d,@design_width,@design_height,@fabric_width,@fabric_height,@fabric_colour,@grid"& _ 
                "1_colour,@grid5_colour,@grid10_colour,@designfile);   "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)
            Me._commandCollection(4).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(7).CommandText = "UPDATE       Projects"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SET                project_name = @project_name, date_star"& _ 
                ...
                ", design_file = @designfile"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (project_id = @project_id);    "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELEC"& _ 
                "T project_id, project_name FROM Projects WHERE (project_id = @project_id)"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, true)>  _
        Public Overloads Overridable Function Delete(ByVal Original_project_id As Integer, ByVal Original_project_name As String, ByVal Original_date_started As Global.System.Nullable(Of Date), ByVal Original_date_ended As Global.System.Nullable(Of Date), ByVal Original_design_width As Integer, ByVal Original_design_height As Integer, ByVal Original_fabric_width As Integer, ByVal Original_fabric_height As Integer, ByVal Original_fabric_colour As Integer, ByVal Original_grid1_colour As Integer, ByVal Original_grid5_colour As Integer, ByVal Original_grid10_colour As Integer, ByVal Original_design_file As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_project_id,Integer)
        ...
        Public Overloads Overridable Function Update( _
            ...
            Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_grid10_colour,Integer)
            If (Original_design_file Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_design_file")
            Else
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_design_file,String)
            End If
